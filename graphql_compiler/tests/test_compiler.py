        ...
        expected_mssql = '''
            ...
            FROM
              ...
              JOIN(
                ...
                FROM
                  db_1.schema_1.[Animal] AS [Animal_2]
                  JOIN db_1.schema_1.[Location] AS [Location_1] ON [Animal_2].lives_in = [Location_1].uuid
              ) AS folded_subquery_1 ON [Animal_1].uuid = folded_subquery_1.uuid
        '''
        expected_postgresql = '''
            SELECT
            ...
            JOIN(
                ...
                ON "Location_1".uuid = "Animal_3".lives_in
        ...
        expected_postgresql = '''
            SELECT
                ...
                coalesce(
                    folded_subquery_1.fold_output_name,
                    ARRAY [] :: VARCHAR []
                ) AS sibling_and_self_names_list FROMschema_1."Animal" AS "Animal_1"
            JOIN(
                SELECT
                    "Animal_2".uuid AS uuid,
                    array_agg("Animal_3".name) AS fold_output_name
                FROM
                    schema_1."Animal" AS "Animal_2"
                JOIN schema_1."Animal" AS "Animal_4" ON "Animal_2".parent = "Animal_4".uuid
                JOIN schema_1."Animal" AS "Animal_3" ON "Animal_4".uuid = "Animal_3".parent
                GROUP BY
                  "Animal_2".uuid
            ) AS folded_subquery_1 ON "Animal_1".uuid = folded_subquery_1.uuid
        '''
            ...
            JOIN (
                SELECT
                    ...
                    (
                      ...
                      WHERE
                        [Animal_3].species = [Species_1].uuid FOR XML PATH ('')
                    ),
                    ''
                  ) AS fold_output_name
...
.out("Animal_LivesIn")[(name = {location})].asList()
    ...
    def test_optional_traversal_and_fold_traversal(self):
        ...
        expected_mssql = '''
            ...
            ON [Animal_1].uuid = folded_subquery_1.uuid
            WHERE [Animal_2].uuid IS NOT NULL OR [Animal_3].uuid ISNULL
        '''
        expected_postgresql = '''
            SELECT
                "Animal_1".name AS animal_name,
            ...
            ON "Animal_3".parent = "Animal_2".uuid
                JOIN(
                    ...
                    FROM schema_1."Animal" AS "Animal_4"
                    JOIN schema_1."Animal" AS "Animal_6" ON "Animal_4".uuid = "Animal_6".parent
                    JOIN schema_1."Animal" AS "Animal_5" ON "Animal_6".uuid = "Animal_5".parent
                    GROUP BY
                        "Animal_4".uuid
            ) AS folded_subquery_1 ON "Animal_1".uuid = folded_subquery_1.uuid
            WHERE
    ...
    def test_fold_traversal_and_optional_traversal(self):
        ...
        expected_mssql = '''
            ...
            WHERE [Animal_2].uuid IS NOT NULL OR [Animal_6].uuid ISNULL
        '''
        expected_postgresql = '''
            SELECT
                "Animal_1".name AS animal_name,
