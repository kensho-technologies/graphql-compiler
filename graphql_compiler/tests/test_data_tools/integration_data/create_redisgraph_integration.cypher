...
create (:Animal {name: 'Animal 1', net_worth: 100, uuid: 'cfc6e625-8594-0927-468f-f53d864a7a51'})
create (:Animal {name: 'Animal 2', net_worth: 200, uuid: 'cfc6e625-8594-0927-468f-f53d864a7a52'})
create (:Animal {name: 'Animal 3', net_worth: 300, uuid: 'cfc6e625-8594-0927-468f-f53d864a7a53'})
create (:Animal {name: 'Animal 4', net_worth: 400, uuid: 'cfc6e625-8594-0927-468f-f53d864a7a54'})
