...
create vertex Species set name = 'Species 1', uuid = 'ce4f0889-ecdb-4e27-8ffa-3140eb507549', alias = ['Species 1']
create vertex Species set name = 'Species 2', uuid = '660b4d07-37fe-4eeb-bb9f-fbc3845e35a9', alias = ['Species 2']
