...
# Generated on 2018-06-29T15:14:50.488887 from compiler version 1.5.0.
...
create vertex Animal set birthday = DATE("2018-11-28 00:00:00"), color = 'red', name = 'Nazgul__2', net_worth = 489.29, uuid = '8b0163c1-cd9d-2b7d-247a-8333f7b0b7d2'
create vertex Animal set birthday = DATE("2015-07-27 00:00:00"), color = 'magenta', name = 'Nazgul__3', net_worth = 603.19, uuid = 'b4e1357d-4a84-eb03-8d1f-d9b74d2b9deb'
create vertex Animal set birthday = DATE("2003-03-18 00:00:00"), color = 'green', name = 'Nazgul__4', net_worth = 656.66, uuid = '935ddd72-5129-fb7c-6288-e1a5cc457821'
create vertex Animal set birthday = DATE("2017-08-27 00:00:00"), color = 'orange', name = 'Nazgul__(024)', net_worth = 579.7, uuid = 'cfc6e625-8594-0927-468f-f53d864a7a50'
...
create vertex Animal set birthday = DATE("2002-08-10 00:00:00"), color = 'green', name = 'Nazgul__(234)', net_worth = 190.38, uuid = '5b7c709a-cb17-5a5a-fb82-860deabca8d0'
...
create vertex Animal set birthday = DATE("2007-12-02 00:00:00"), color = 'yellow', name = 'Nazgul__((234)34)', net_worth = 21.64, uuid = '9371a71f-d480-865f-9b38-fe803042e325'
...
create vertex Animal set birthday = DATE("2017-03-19 00:00:00"), color = 'orange', name = 'Nazgul__((024)(234)3)', net_worth = 966.55, uuid = 'bb4a06cb-e786-ab37-5bca-47be429817c5'
...
create vertex Animal set birthday = DATE("2007-07-15 00:00:00"), color = 'yellow', name = 'Nazgul__((013)(234)0)', net_worth = 311.45, uuid = '2cc0f859-aa65-24ab-713b-7e05ebe21368'
...
create vertex Animal set birthday = DATE("2007-08-01 00:00:00"), color = 'yellow', name = 'Nazgul__((((234)34)01)24)', net_worth = 192.31, uuid = 'b732d46f-21e1-5094-9efe-e464da90f534'
...
create vertex Animal set birthday = DATE("2012-07-27 00:00:00"), color = 'red', name = 'Pteranodon__2', net_worth = 938.44, uuid = '04c14982-d9ea-d926-4745-dd9e27896389'
create vertex Animal set birthday = DATE("2017-08-11 00:00:00"), color = 'black', name = 'Pteranodon__3', net_worth = 537.93, uuid = 'a7c5cb87-9b8b-71a1-b38a-05fbf61164ce'
create vertex Animal set birthday = DATE("2005-05-11 00:00:00"), color = 'blue', name = 'Pteranodon__4', net_worth = 93.71, uuid = '4a814d53-964d-db77-6025-f0ae35354579'
create vertex Animal set birthday = DATE("2010-04-14 00:00:00"), color = 'yellow', name = 'Pteranodon__(034)', net_worth = 239.71, uuid = '4a1eb1b7-955d-0e77-fb5e-b8662640211e'
...
create vertex Animal set birthday = DATE("2009-06-14 00:00:00"), color = 'yellow', name = 'Pteranodon__(((034)02)((034)04)3)', net_worth = 584.89, uuid = '0202861c-6283-0869-0fa7-ee0538974df5'
...
create vertex Animal set birthday = DATE("2007-07-05 00:00:00"), color = 'blue', name = 'Pteranodon__(((034)02)13)', net_worth = 988.69, uuid = '25777cf0-9f98-2188-3744-da64cc249558'
...
create vertex Animal set birthday = DATE("2016-08-05 00:00:00"), color = 'magenta', name = 'Pteranodon__((((034)02)13)(((034)02)23)(034))', net_worth = 379.01, uuid = '52631db9-d170-34ce-5179-7350e6256403'
...
create vertex Animal set birthday = DATE("2014-06-25 00:00:00"), color = 'green', name = 'Pteranodon__((((034)02)((034)04)3)(034)3)', net_worth = 800.65, uuid = '21681081-399f-8a8f-10fc-9eee0a1727f7'
...
create vertex Animal set birthday = DATE("2015-08-01 00:00:00"), color = 'orange', name = 'Dragon__1', net_worth = 181.97, uuid = '961d8dcf-9b80-86da-6379-4035f8e45086'
create vertex Animal set birthday = DATE("2004-10-22 00:00:00"), color = 'yellow', name = 'Dragon__2', net_worth = 384.16, uuid = '552ae5ca-4124-405b-91fc-fe8881c16e98'
...
create vertex Animal set birthday = DATE("2008-06-03 00:00:00"), color = 'red', name = 'Dragon__4', net_worth = 778.15, uuid = '5a4f4145-fc98-c279-cf6f-111c26c06e67'
...
create vertex Animal set birthday = DATE("2008-10-13 00:00:00"), color = 'orange', name = 'Dragon__((024)34)', net_worth = 789.56, uuid = '306aa871-feef-71cb-c915-d113dc45488d'
...
create vertex Animal set birthday = DATE("2007-09-04 00:00:00"), color = 'magenta', name = 'Dragon__((((((024)34)04)02)23)((((024)34)04)02)2)', net_worth = 299.39, uuid = 'dc68d4fd-0bd7-696f-a9c7-2e7b6b770df1'
...
create vertex Animal set birthday = DATE("2007-12-02 00:00:00"), color = 'yellow', name = 'Dragon__((((((024)34)04)02)23)((024)34)(024))', net_worth = 408.63, uuid = '15a5712c-5ac4-b6c7-a310-34dd4c4b91fe'
...
create vertex Animal set birthday = DATE("2003-02-04 00:00:00"), color = 'red', name = 'Dragon__(((024)12)(024)3)', net_worth = 605.55, uuid = 'f3cc9d8a-4b16-78e4-5f20-f4063438b4e4'
...
create vertex Animal set birthday = DATE("2018-05-15 00:00:00"), color = 'blue', name = 'Hippogriff__0', net_worth = 355.37, uuid = '6bf4d047-c484-1a8d-2f75-1bde66163e5b'
...
create vertex Animal set birthday = DATE("2012-05-22 00:00:00"), color = 'yellow', name = 'Hippogriff__4', net_worth = 788.18, uuid = '88083ebc-35d4-cd35-a08c-3a0085e74250'
...
create vertex Animal set birthday = DATE("2008-11-01 00:00:00"), color = 'red', name = 'Hippogriff__((134)14)', net_worth = 526.83, uuid = '9f032cdc-e328-66d3-0d6a-78b07eda9ab9'
...
create vertex Animal set birthday = DATE("2015-06-06 00:00:00"), color = 'black', name = 'Hippogriff__((((134)14)02)34)', net_worth = 710.0, uuid = '7df0fe6b-ce8d-75f2-6d62-e40c638d521a'
...
create vertex Animal set birthday = DATE("2009-12-27 00:00:00"), color = 'black', name = 'Hippogriff__(((((134)14)02)34)(134)0)', net_worth = 929.76, uuid = '7552c6e8-6953-a115-5a62-ddc4e2091f49'
...
create vertex Animal set birthday = DATE("2016-05-24 00:00:00"), color = 'red', name = 'Hippogriff__((134)34)', net_worth = 251.28, uuid = '30ac79dd-0b5a-afef-85a1-282a0761585b'
