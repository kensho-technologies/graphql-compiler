...
def get_autogenerated_schema(graphql_client):
    schema_records = graphql_client.command(ORIENTDB_SCHEMA_RECORDS_QUERY)
...
class IntegrationTests(TestCase):
    ...
    def test_snapshot_graphql_schema_from_orientdb_schema(self):
        schema = get_autogenerated_schema(self.graphql_client)
