...
from . import backends as test_backend
...
def use_all_backends(except_backends: Tuple[str, ...] = ()) -> Callable:
    ...
    non_excluded_backends = [
        backend
        for backend in test_backend.BACKENDS_WITH_INTEGRATION_TESTS
...
class IntegrationTests(TestCase):
    ...
    def compile_and_run_query(
        ...
        if backend_name in test_backend.SQL_BACKENDS:
