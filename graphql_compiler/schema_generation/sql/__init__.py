...
def get_sql_schema_info(
    ...
    """Return a SQLSchemaInfo from the metadata.
    ...
    Constructing the SQLSchemaInfo class, which contains all the info required to compile
    ...
    Args:
        vertex_name_to_table: dict, str -> SQLAlchemy Table. This dictionary is used to generate the
                              GraphQL objects in the schema in the SQLSchemaInfo. Each
