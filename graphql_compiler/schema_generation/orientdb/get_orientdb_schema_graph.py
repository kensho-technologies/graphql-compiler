...
from ..schema_graph import (
    EdgeType, NonGraphElement, SchemaGraph, VertexType, get_subclass_sets_from_inheritance_sets
)
from .schema_properties import (
    ...
    PROPERTY_TYPE_LINK_ID, PropertyDescriptor, get_graphql_scalar_type_or_raise,
