...
def _get_type_relationship_error_description_text(subclass_sets, current_type, other_type):
    ...
    if current_type in subclass_sets[other_type]:
        ...
        raise AssertionError(u'Conflict between two types that '
                             u'are not each other\'s supertype: {} {} {}'
                             .format(current_type, other_type, subclass_sets))
...
def _raise_macro_reversal_conflict_error(new_macro_descriptor, existing_descriptor,
    ...
    if not specific_resolution_advice:
        raise AssertionError(
            u'No specific error resolution advice given, this should never happen: {} {} {}'
            .format(new_macro_descriptor, existing_descriptor, specific_resolution_advice))
    ...
    raise GraphQLInvalidMacroError(
        ...
        u'{specific_advice}.'
        u'Conflicting macro edge definition: {macro_graphql} with args {macro_args}'
        .format(edge_name=new_macro_descriptor.macro_edge_name,
