...
def get_unique_vertex_name_from_location(location):
    ...
    if isinstance(location, FoldScopeLocation):
        return fold_scope_location_full_path_name(location)
...
def collected_vertex_list_name(full_path_name):
...
def _emit_code_from_cypher_step(cypher_step):
    ...
    if cypher_step.linked_location is None:
        ...
        linked_location_name = get_unique_vertex_name_from_location(cypher_step.linked_location)
...
def _emit_with_clause_components(cypher_steps):
    ...
    for cypher_step in cypher_steps:
        ...
        location_name = get_unique_vertex_name_from_location(location)
        if isinstance(location, FoldScopeLocation):
            location_name = collected_vertex_list_name(location_name)
        else:
...
def _emit_with_clause_components_for_current_fold_scope(current_fold_scope_cypher_steps):
    ...
    for cypher_step in current_fold_scope_cypher_steps:
        ...
        collected_name = collected_vertex_list_name(full_vertex_name)
