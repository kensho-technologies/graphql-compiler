...
def get_fold_scope_location_full_path_name(fold_scope_location):
    ...
    if not (isinstance(fold_scope_location, FoldScopeLocation)):
        raise TypeError(
            u"Expected cypher_step.as_block.location to be of type "
            u"FoldScopeLocation. Instead, got object {} of type {}.".format(
    ...
    if base_location.field is not None:
        raise ValueError(
            u"Expected base_location's field to be None since this method is used to "
...
def get_unique_vertex_name_from_location(location):
    ...
    raise TypeError(
        u"Expected location to be of type Location or FoldScopeLocation. Instead got "
