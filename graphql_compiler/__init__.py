...
def graphql_to_cypher_redisgraph(schema, graphql_query, parameters, type_equivalence_hints=None):
...
def graphql_to_cypher_neo4j(schema, graphql_query, parameters, type_equivalence_hints=None):
    """Compile the GraphQL input using the schema into a Cypher query and associated metadata.
