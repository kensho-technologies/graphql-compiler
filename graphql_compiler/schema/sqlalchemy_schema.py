...
SQLAlchemySchemaInfo = namedtuple('SQLAlchemySchemaInfo', (
    ...
    'tables',     # dict mapping every graphql object type name in the schema to a sqlalchemy table
    'junctions',  # dict mapping every graphql object type name in the schema to:
