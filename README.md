...
```
Notice that in the first case where the optional edge is not followed,
...
Note that the previous example is not *exactly* how we implement *compound* optionals
