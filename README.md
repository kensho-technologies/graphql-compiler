...
# This code is a mock example. It is not executable. It assumes that:
# - The client variable refers to a pyorient client.
# - The OrientDB schema contains an 'Animal' type with 'name' and 'net_worth' fields.

# Step 1: Generate GraphQL schema from the database schema metadata.
...
# Step 2: Write GraphQL query to get the names of all animals with a particular net worth.
...
# Step 3: Use autogenerated GraphQL schema to compile query into the target database language.
compilation_result = graphql_to_match(schema, graphql_query, parameters, type_equivalence_hints)

# Step 4: Run compiled query.
