...
queries. The primary specifications for how to write a GraphQL query are outlined in the
...
# Step 1: Generate GraphQL schema from database metadata.
...
# Step 3: Use autogenerated GraphQL schema to compile query into database language.
